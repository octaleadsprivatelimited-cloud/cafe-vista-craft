        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-4 sm:px-8 py-4 rounded-lg font-semibold hover:bg-primary/90 transition-colors text-sm sm:text-base w-full sm:w-auto"
            >
              ...
              <span className="whitespace-normal sm:whitespace-nowrap">Order via WhatsApp</span>
            </a>
          </motion.div>
        </div>
      </section>
