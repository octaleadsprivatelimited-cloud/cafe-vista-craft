...
const contactInfo = [
  {
    icon: MapPin,
    title: "Visit Us",
    content: "123 Coffee Street, Café District\nNew York, NY 10001",
  },
  {
    icon: Phone,
    title: "Call Us",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="mt-8 p-6 bg-accent/10 rounded-xl">
                ...
                <a
                  href="https://wa.me/1234567890?text=Hi! I have a question about Brew & Bean."
                  target="_blank"
            ...
            >
              ...
              <div className="rounded-xl overflow-hidden shadow-lg">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.9663095919364!2d-74.00425878428698!3d40.74076794379132!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259bf5c1654f3%3A0xc80f9cfce5383d5d!2sGoogle!5e0!3m2!1sen!2sus!4v1643723400000!5m2!1sen!2sus"
                  width="100%"
                  height="350"
                  style={{ border: 0 }}
                  allowFullScreen
            ...
            {[
              {
                ...
                a: "Yes! You can order via WhatsApp for delivery within a 5-mile radius. Minimum order of $15 applies.",
              },
              {
                q: "Can I book the café for private events?",
                a: "Absolutely! We offer private event bookings for groups of 20+. Contact us for pricing and availability.",
              },
              {
                q: "Do you have dairy-free options?",
                a: "Yes, we offer oat milk, almond milk, and coconut milk as alternatives at no extra charge.",
              },
              {
